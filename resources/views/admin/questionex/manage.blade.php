...
'title' => 'Blank Page',
'pageTitle' => "Edit Contoh Soal Untuk ".$class->class_name,
])
@section('content')
    ...
    <div class="card border-left-primary shadow h-100">
        <div id="accordianId" role="tablist" aria-multiselectable="true">
            <form action="{{ route('questionex.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <h5 class="mb-0">
                            <a data-toggle="collapse" data-parent="#accordianId" href="#newFormula" aria-expanded="true"
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                    ...
                                    Buat Contoh Soal Baru Untuk  {{ $class->class_name }}
                                </button>
                            </a>
                        </h5>
                    </div>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Nama
                                        Soal (Tidak Wajib Diisi)
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="title" id="" aria-describedby="helpId"
                                            placeholder="">
                                        <small id="helpId" class="form-text text-muted">Masukkan Nama Soal
                                            Disini</small>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="font-weight-bold text-primary text-uppercase mb-1">Pembahasan Soal</div>
                        ...
                        },
                        {
                            ...
                            render: function(datum, type, row) {
                                ...
                                const html =
                                    ...
                                    '<span class = "text" > Hapus Soal Ini </span>'
                                '</button>';
                                return html;
                            }
                        }
