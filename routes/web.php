...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('/admin/formula/{id}/edit', 'FormulaController@viewAdminEdit')->name("formula.destroy");
	Route::post('/formula/update', 'FormulaController@update')->name("formula.update");
